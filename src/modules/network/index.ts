...
export const rpcUrls = {
  ...
  [CHAIN.ASTAR_MAINNET]: ['https://evm.astar.network'],
  [CHAIN.ASTAR_TESTNET]: ['https://evm.shibuya.astar.network'],
  [CHAIN.SHIDEN_MAINNET]: ['https://evm.shiden.astar.network'],
  [CHAIN.SHIDEN_TESTNET]: ['https://evm.shibuya.astar.network'],
...
export const blockExplorerUrls = {
  ...
  [CHAIN.ASTAR_MAINNET]: ['https://blockscout.com/astar'],
  [CHAIN.ASTAR_TESTNET]: ['https://blockscout.com/shibuya'],
  [CHAIN.SHIDEN_MAINNET]: ['https://blockscout.com/shiden'],
  [CHAIN.SHIDEN_TESTNET]: ['https://blockscout.com/shibuya'],
